        ...
        <table class="table table-striped-columns">
          ...
          <tbody>
            ...
            <tr class="text-center">
              ...
              <td>{{($penduduk->rt_id!=null ? "RT {$penduduk->rt_id}/ RW {$penduduk->rt->rw->id}/ DUSUN {$penduduk->rt->rw->dusun->deskripsi}" : "-")}}</td>


              <td>
                <a href="/data_penduduk/detail/{{$penduduk->id}}"><button class="btn btn-primary p-1"
                    title="Tampil"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                      class="bi bi-person-fill" viewBox="0 0 16 16">
                      <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                    </svg></button></a>
                <a href="/data_penduduk/edit/{{$penduduk->id}}"><button class="btn btn-info p-1" title="Edit"><svg
                ...
                <a href="/data_penduduk/keluar/{{$penduduk->id}}"><button class="btn btn-warning p-1"
                    title="Keluar"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                ...
                <a href="#"><button class="btn btn-danger p-1" title="Hapus"><svg xmlns="http://www.w3.org/2000/svg"
